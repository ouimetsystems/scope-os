...
export default function NewClientPage() {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <h1 className="text-2xl font-semibold mb-6 text-gray-900">New Client</h1>
      <form action={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium mb-1 text-gray-700">Company Name *</label>
          <input name="company_name" required className="w-full border rounded px-3 py-2 text-gray-900" />
          {errors?.company_name && (
        ...
        <div>
          ...
          <input name="industry" className="w-full border rounded px-3 py-2 text-gray-900" />
        </div>

        <div>
          <label className="block text-sm font-medium mb-1 text-gray-700">Status</label>
          <select name="status" defaultValue="prospect" className="w-full border rounded px-3 py-2 text-gray-900">
        ...
        <div>
          ...
          <textarea name="notes" rows={4} className="w-full border rounded px-3 py-2 text-gray-900" />
        </div>
